        ...
        <article className="lg:col-span-8 space-y-16">
          ...
          <section>
            ...
            <div className="mt-6 relative h-[260px] w-full overflow-hidden rounded-3xl bg-black/5">
              {/* <Image src="" alt="Simulink spacecraft dynamics block diagram" fill className="object-contain" sizes="(max-width: 768px) 100vw, 800px" /> */}
            </div>
          ...
          <section>
            ...
            <div className="mt-6 relative h-[220px] w-full overflow-hidden rounded-3xl bg-black/5">
              {/* <Image src="" alt="Disturbance torque magnitudes vs. time" fill className="object-contain" sizes="(max-width: 768px) 100vw, 800px" /> */}
            </div>
          ...
          <section>
            ...
            <div className="mt-4 grid grid-cols-1 gap-4 md:grid-cols-2">
              <div className="relative h-[220px] overflow-hidden rounded-3xl bg-black/5">
                {/* <Image src="" alt="EKF quaternion estimate vs. true attitude" fill className="object-contain" sizes="(max-width: 768px) 100vw, 800px" /> */}
              </div>
              <div className="relative h-[220px] overflow-hidden rounded-3xl bg-black/5">
                {/* <Image src="" alt="Gyro bias estimate convergence" fill className="object-contain" sizes="(max-width: 768px) 100vw, 800px" /> */}
              </div>
            </div>
          ...
          <section>
            ...
            <div className="mt-4 grid grid-cols-1 gap-4 md:grid-cols-2">
              <div className="relative h-[220px] overflow-hidden rounded-3xl bg-black/5">
                {/* <Image src="" alt="Quaternion error vs. time — slew manoeuvre" fill className="object-contain" sizes="(max-width: 768px) 100vw, 800px" /> */}
              </div>
              <div className="relative h-[220px] overflow-hidden rounded-3xl bg-black/5">
                {/* <Image src="" alt="Reaction wheel speeds vs. time" fill className="object-contain" sizes="(max-width: 768px) 100vw, 800px" /> */}
              </div>
            </div>
