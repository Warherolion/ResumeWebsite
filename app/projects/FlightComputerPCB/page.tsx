            ...
            <dl className="mt-4 grid grid-cols-1 gap-4 text-sm">
              ...
              <div className="flex items-start justify-between gap-6">
                ...
                <dd className="text-black/80">
                  Stabilize attitude with canards + onboard estimation.
                </dd>
              </div>
              ...
              <div className="flex items-start justify-between gap-6">
                ...
                <dd className="text-black/80">
                  STM32 • IMU • MATLAB/Simulink • CAD/FEA
                </dd>
              </div>
        ...
        <article className="lg:col-span-8 space-y-12">
          <section>
            ...
            <p className="mt-3 text-black/70">
              {/* Write-up goes here */}
              Describe the project in 5–8 sentences: what you built, why it matters,
          ...
          <section>
            ...
            <ul className="mt-4 list-disc space-y-2 pl-5 text-black/70">
              <li>Stability target: ____ (e.g., roll rate, angle error, settling time)</li>
              <li>Constraints: mass, power, actuator limits, launch vibration</li>
              <li>Sensor + compute limits (IMU rate, CPU budget, latency)</li>
